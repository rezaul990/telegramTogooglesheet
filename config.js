...
module.exports = {
  ...
  SPREADSHEET_ID_D: process.env.SPREADSHEET_ID_D || '16G6Uip6EJIT-D7I0SeX-sRpuVwb4CCQf8tchuudcSws',
  SPREADSHEET_ID_E: process.env.SPREADSHEET_ID_E || '12o2KXhqV7KSvX4L1IuDXaUJXSBjp_lvmRPJZzZgsJ_s',
